...
--
-- Current Database: `library_project`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `library_project` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `board_notice` VALUES ('일이삼사 도서관 공지입니다.','일이삼사 도서관 공지 테스트 게시글입니다.'),('도서관 이용안내','1. 회원 1인당 총 10권까지 대출 가능\r\n2. 도서 반납은 대출한 본인만 가능'),('개발자 깃허브(19831049이민혁)','https://github.com/acredev'),('테스트 1 (제목)','테스트 1 (내용)'),('테스트 2 (제목)','테스트 2 (제목)'),('테스트 3 (제목)','테스트 3 (제목)');
...
INSERT INTO `board_qna` VALUES ('2211253659','이민혁','m_file@naver.com','test6','test6',NULL);
...
INSERT INTO `member` VALUES ('111111111112','테스트계정','test','test','남자','경기도 의정부시','010-0001-0002','1999-01-02','m_file@kyungmin.ac.kr','2022-12-01','3','정상'),('2211253659','이민혁','min3659111','test','남자','테스트','010-0000-0000','1999-05-19','m_file@naver.com','2022-11-25','5','정상');
...
-- Dump completed on 2022-12-01 21:16:11
